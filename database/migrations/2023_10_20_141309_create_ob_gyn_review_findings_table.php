...
return new class extends Migration
{
    ...
    {
        Schema::create('ob_gyn_review_findings', function (Blueprint $table) {
            $table->id();
            $table->unsignedBigInteger('ob_gyn_review_id')->nullable();  // Add ob_gyn_review_id
            //OB-GYNE History
            ...
            $table->foreign('ob_gyn_review_id')->references('id')->on('ob_gyn_reviews');
        });
    }
    ...
    {
        Schema::dropIfExists('ob_gyn_review_findings');
    }
};
