...
<a class="btn btn-danger mb-2" href="{{ route('admin.recordIndex') }}">Go Back</a>
        ...
        <div class="col">
            <div class="row-col-1 py-3" >
                ...
                <div class="col my-1">
                    ...
                    <a class="info btn btn-outline-info" href="{{ route('admin.recordEdit', $record->id ) }}">Update Info</a>
                    @endif
                </div>
            </div>
        </div>
...
<script type="text/javascript">
    document.addEventListener('DOMContentLoaded', function () {
        ...
        consultation_date.addEventListener('change', function () {
            ...
            $.ajax({
                type: 'GET',
                url: '/admin/record/' + recordId + '/consultation/',
        ...
        medical_exam_date.addEventListener('change', function(){
            ...
            $.ajax({
                type: 'GET',
                url: '/admin/record/' + recordId + '/medical-exam/',
        ...
        dental_exam_date.addEventListener('change', function(){
            ...
            $.ajax({
                type: 'GET',
                url: '/admin/record/' + recordId + '/dental-exam/',
